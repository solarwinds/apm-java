...
public final class BsonDocuments {
   ...
   *
   * @param map the map whose key-value pairs will be used to initialize the new document
  ...
  /**
   * Returns a new document containing the key-value pairs: <em>k1: v1, k2: v2, etc.</em>
   *
   * @return a new document containing the key-value pairs: <em>k1: v1, k2: v2 etc.</em>
  ...
  /**
   * Returns a new document containing the key-value pairs: <em>k1: v1, k2: v2</em>.
   *
   * @return a new document containing the key-value pairs: <em>k1: v1, k2: v2</em>
   * @throws NullPointerException if any key-value pair's key is null
   * @throws IllegalArgumentException if there are duplicate keys
   */
  public static BsonDocument of(String k1, @Nullable Object v1, String k2, @Nullable Object v2) {
  ...
  /**
   * Returns a new document containing {@code key} and its associated {@code value}.
   *
   * @param key the key that will be used to initialize the new document
   * @param value the value associated with {@code key}
   * @return a new document containing {@code key} and its associated {@code value}
