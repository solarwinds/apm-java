...
public class AppOpticsContextPropagator implements TextMapPropagator {
    ...
    public <C> void inject(@Nonnull Context context, @Nullable C carrier, @Nonnull TextMapSetter<C> setter) {
        ...
        final String swTraceStateValue = spanContext.getSpanId() + "-" + (spanContext.isSampled() ? "01" : "00");
        ...
        final String traceOptionsSignature = context.get(TriggerTraceContextKey.XTRACE_OPTIONS_SIGNATURE);
