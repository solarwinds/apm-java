...
public class TraceStateSamplingResult implements SamplingResult {
    ...
    public static final String SW_SPAN_PLACEHOLDER_SAMPLED = "SWSpanIdPlaceHolder-01";
    public static final String SW_SPAN_PLACEHOLDER_NOT_SAMPLED = "SWSpanIdPlaceHolder-00";
