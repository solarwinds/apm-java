...
import com.solarwinds.joboe.rpc.ClientManagerProvider;
...
import com.solarwinds.monitor.MetricsCollector;
import com.solarwinds.monitor.MetricsMonitor;
import com.solarwinds.monitor.SystemMonitorController;
import com.solarwinds.monitor.SystemMonitorFactoryImpl;
            ...
            () -> {
              try {
                ...
                EventImpl.setDefaultReporter(
                    RpcEventReporter.buildReporter(RpcClientManager.OperationType.TRACING));
