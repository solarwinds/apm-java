...
class InboundMeasurementMetricsGeneratorTest {
    ...
    @InjectMocks
    private InboundMeasurementMetricsGenerator tested;
    ...
    void verifyMetricAttributeValuesIsCorrectWhenNotErrorSpan() {
        ...
        boolean allMatch = attributesArgumentCaptor.getAllValues()
                .stream()
                .allMatch(attributes ->
    ...
    void ensureCountersAreOnlyIncrementedByOne() {
        ...
        boolean allMatch = longArgumentCaptor.getAllValues()
                .stream()
